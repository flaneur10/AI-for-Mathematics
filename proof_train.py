...
class ScriptArguments:
    ...
    dataset_name: Optional[str] = field(
        default="datasets/wellecks/naturalproofs-gen",
    ...
    max_steps: int = field(default=50, metadata={"help": "How many optimizer update steps to take"})
...
model.add_adapter(lora_config, adapter_name="theory_adapter")
...
output_dir = f"{YOUR_HF_USERNAME}/gemma-mathinstruct-adaptor-theory"
...
# save_dir = "tuned_model/gemma-adaptor-theory"
