...
class ScriptArguments:
    ...
    dataset_name: Optional[str] = field(
        default="datasets/microsoft/orca-math-word-problems-200k",
...
model.add_adapter(lora_config, adapter_name="application_adapter")
...
output_dir = f"{YOUR_HF_USERNAME}/gemma-mathinstruct-adaptor-application"
