...
class ScriptArguments:
    ...
    lora_dropout: Optional[float] = field(default=0.5)
    ...
    dataset_name: Optional[str] = field(
        default="datasets/TIGER-Lab/MathInstruct",
...
output_dir = f"{YOUR_HF_USERNAME}/gemma-it-qlora-mathintruct"
...
save_dir = "tuned_model/gemma-it-qlora-mathintruct"
